...
Before you can create a class, you must first create the **class**.\
...
You can check if the created class appears properly at the top of the left menu.
...
When a subject specialist creates a class, all classes share a single invitation code and cannot be managed separately.

Therefore, you should manage each class individually after creating them.
...
- Regardless of how many lessons you add to your schedule, all lessons for the same class will share the same invitation code.
