...
To log in as an administrator, **you must first receive an administrator account from headquarters.**

Administrator account application: [**🔗link**](http://admin.focuspang.com).
...
Initially, **Only one administrator account** is issued per school, but if the school needs more administrator teachers while operating focuspang, **they can directly grant permissions later.**
